...
![website layouts](/images/website-layout.PNG)
...
![homepage design with color](/images/website-design-1.png)
...
![about me page design with color](/images/website-design-2.png)

#### Development Process
*December 14, 2020:*
The site is currently accessible through [dorayguo.github.io](http://dorayguo.github.io/).
I will be gradually start adding blog posts and project content. Design integration will be delayed for now.

*December 20, 2020:*
I forked the aforementioned Tom Preston-Werner's blog, and moved my blog content from the original repo to this forked one. I benefited a lot from the clean look and formatting. I also made HTML and CSS modifications to adapt to my designs and content, such as font styling, background color, etc.

It currently looks like this:

![current website design](/images/website-dev-1.PNG)

*January 10, 2021:*
I've made the site mobile responsive, so that everything is readable when it's opened on a phone. However, there are some small details (such as the right margins and width mismatches) that don't seem to work despite my attempts to fix them. Nonetheless, it's better than before. I may tackle the issue of needing to scroll left to right, because the width of the site is slightly wider than the phone screen on the landing page and about me page. It may be an issue of overwriting the stylistic choices somewhere.

I also linked back to the Jekyll repo to give the base HTML and CSS credit to Tom Preston-Werner.

Tomorrow, I plan on starting a blog post to record this week's MLH Local Hack Day: Build.
